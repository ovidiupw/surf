...
public class ApiAuthorizerLambdaRole implements IAMRoleConfig {
    private static final String ROLE_NAME = toNormalizedLambdaRoleName("api_authorizer");
    ...
    private static final String ACCESS_POLICY_PATH
            = "src/main/resources/iam_policy_documents/api_authorizer_lambda_access_policy.json";
