...
public class ListWorkflowExecutionsLambdaRole implements IAMRoleConfig {

    private static final String ROLE_NAME = toNormalizedLambdaRoleName("list_workflow_executions");
    ...
    private static final String ACCESS_POLICY_PATH
            = "src/main/resources/iam_policy_documents/list_workflow_executions_lambda_access_policy.json";
