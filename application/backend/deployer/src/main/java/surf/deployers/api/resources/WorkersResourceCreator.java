...
public class WorkersResourceCreator extends SkeletalResourceCreator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(WorkersResourceCreator.class);
    private static final String GET_INTEGRATION_TEMPLATE_FILE_PATH
            = "src/main/resources/api/integration_templates/workers.get.template";
    ...
    public WorkersResourceCreator(@Nonnull final CreateRestApiResult restApi,
    ...
    public Resource create(@Nonnull final Resource parentResource, @Nonnull final String pathPart) {
        ...
        final Resource resource = ObjectConverter.toApiResource(this.createApiResource(parentResource, pathPart));
