...
public class FinalizeCrawlSessionLambdaRole implements IAMRoleConfig {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FinalizeCrawlSessionLambdaRole.class);
    ...
    public FinalizeCrawlSessionLambdaRole(@Nonnull final Role sfnInvokeLambdaRole, @Nonnull final String awsAccountId) {
