...
public class StartWorkflowLambdaRole implements IAMRoleConfig {
    private static final String ROLE_NAME = toNormalizedLambdaRoleName("start_workflow");
    ...
    private static final String ACCESS_POLICY_PATH
            = "src/main/resources/iam_policy_documents/start_workflow_lambda_access_policy.json";
