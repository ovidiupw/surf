...
public class ListVisitedPagesForWorkflowExecutionLambdaRole implements IAMRoleConfig {

    private static final String ROLE_NAME = toNormalizedLambdaRoleName("list_visited_pages_for_execution");
    ...
    private static final String ACCESS_POLICY_PATH
            = "src/main/resources/iam_policy_documents/list_visited_pages_for_workflow_execution_lambda_access_policy.json";
